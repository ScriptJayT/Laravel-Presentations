...
export const SectionHeadingClasses = () => ["text-lg", "md:text-xl", "font-semibold", "tracking-tight"];
export const SubSectionHeadingClasses = () => ["text-md", "md:text-lg", "font-semibold"];
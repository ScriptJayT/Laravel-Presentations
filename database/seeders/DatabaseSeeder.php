...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $rules = $this->seedVisibilities();
        $themes = $this->seedThemes();

        $this->seedBotUser($rules, $themes->base_id);
    }
    ...
    {
        $public = PresentationVisibility::factory()->create([
            'title' => Visibility::PUBLIC->title(),
            'name' => 'Public',
        ]);
        $protected = PresentationVisibility::factory()->create([
            'title' => Visibility::PROTECTED->title(),
            'name' => 'Protected',
        ]);
        $private = PresentationVisibility::factory()->create([
    ...
    private function seedThemes(): object
    {
        $defaultTheme = PresentationTheme::factory()->create(['title' => 'base']);

        return (object) ['base_id' => $defaultTheme->id];
    }

    private function seedBotUser(object $rules, int $theme_id): void
    {
        ...
        $exampleScript = PresentationScript::factory()->create([
            ...
            'user_id' => $botUser->id,
            'presentation_visibility_id' => $rules->protected_id,
        ]);
        $examplePresentation = Presentation::factory()->create([
            ...
            'user_id' => $botUser->id,
            'presentation_visibility_id' => $rules->protected_id,
            'presentation_theme_id' => $theme_id,
        ...
        Presentation::factory()->create([
            ...
            'user_id' => $botUser->id,
            'presentation_visibility_id' => $rules->public_id,
            'presentation_theme_id' => $theme_id,
        ...
        Presentation::factory()->create([
            ...
            'user_id' => $botUser->id,
            'presentation_visibility_id' => $rules->private_id,
            'presentation_theme_id' => $theme_id,
            'presentation_script_id' => null,
        ]);
    }
